...
CallSort:                           # preparo i registri per la chiamata a insertionSort
    
    movl $ArrayPointer, %esi         # muove l'indirizzo di ArrayPointer in esi
    pushl %esi
    pushl len

    call insertionSort                  # chiama la funzione insertionSort
